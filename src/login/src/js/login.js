...
async function getLogin() {
    ...
    studentData = [
        ...
        {instance_id: null, student_id: 'ma2011', student_name: 'Mahnoor Aziz', degree_title: 'Advanced Computer Science - MSc'},
        {instance_id: null, student_id: 'rb756', student_name: 'Rosa Baker', degree_title: 'Advanced Computer Science - MSc'},
        {instance_id: null, student_id: 'amsb2', student_name: 'Abdullah Bakhashwain', degree_title: 'Networks and Security - MSc'},
        {instance_id: null, student_id: 'mjb240', student_name: 'Michael Bateman', degree_title: 'Computer Science - MSc'},
        {instance_id: null, student_id: 'ovyb2', student_name: 'Olivier Belan', degree_title: 'Advanced Computer Science - MSc'},
        {instance_id: null, student_id: 'spab2', student_name: 'Sebastien Bernard', degree_title: 'Networks and Security - MSc'},
        {instance_id: null, student_id: 'evb9', student_name: 'Etienne Bertrand', degree_title: 'Advanced Computer Science - MSc'},
        {instance_id: null, student_id: 'nsb26', student_name: 'Nathan Bonnot', degree_title: 'Networks and Security - MSc'},
        {instance_id: null, student_id: 'maeb3', student_name: 'Mael Brocher', degree_title: 'Networks and Security - MSc'},
        {instance_id: null, student_id: 'otb3', student_name: 'Owen Buckley', degree_title: 'MSc Computer Science Conversion'},
        {instance_id: null, student_id: 'djc70', student_name: 'Daniel Chapman', degree_title: 'MSc Computer Science Conversion'},
        {instance_id: null, student_id: 'tc503', student_name: 'Tristan Choy', degree_title: 'MSc Computer Science Conversion'},
        {instance_id: null, student_id: 'dmc36', student_name: 'Daniel Constant', degree_title: 'Advanced Computer Science - MSc'},
        {instance_id: null, student_id: 'ka420', student_name: 'Joshua Cooper', degree_title: 'MSc Computer Science Conversion'},
    ];
